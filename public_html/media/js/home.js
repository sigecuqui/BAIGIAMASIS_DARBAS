        ...
        feedback: {
            ...
            onClickListener: function (e) {
                ...
                if (e.target.className === 'feedback') {
                    ...
                    // Find container of the button, which has ID
                    let item = e.target.closest('.data-item');
                    console.log('Feedback button clicked on', item);

                    formData.append('id', item.getAttribute('data-id'));
                    api(endpoints.feedback, formData, grid.buttons.feedback.success, grid.buttons.feedback.fail);
                }
            },
            success: function (data) {
